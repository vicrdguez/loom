...
case $url in
  *'/api/v1/repos/vicrodriguez/loom/releases?'*)
...
JSON
  ...
  assert_status 0
  assert_contains "$log" "/api/v1/repos/vicrodriguez/loom/releases?"
...
JSON
  ...
  assert_status 0
  assert_not_contains "$log_env" "/api/v1/repos/vicrodriguez/loom/releases?"
  ...
  assert_status 0
  assert_not_contains "$log_cli" "/api/v1/repos/vicrodriguez/loom/releases?"
...
JSON
  ...
  assert_status 1
  assert_contains "$CURRENT_OUT" "No stable Loom release found on Codeberg"
  assert_contains "$log" "/api/v1/repos/vicrodriguez/loom/releases?"
...
JSON
    ...
    assert_status 0
    assert_contains "$log" "$downloader https://codeberg.org/vicrodriguez/loom/archive/v0.1.0.tar.gz"
    assert_exists "$project/.codex/skills/loom-explore/SKILL.md"
  done
}
